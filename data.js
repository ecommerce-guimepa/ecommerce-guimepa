...
const data = [
  { fornecedor:"Vonder", logo:"Vonder.png", status:"Ativo", lote:"-", prod:"sim", rk:1, resp:"Bruno", producao:130, prontos:0, produzir:130, restantes:0 },
  { fornecedor:"Tramontina", logo:"Tramontina.png", status:"Ativo", lote:"1o", prod:"sim", rk:1, resp:"Lucas", producao:2924, prontos:0, produzir:3500, restantes:576 },
  { fornecedor:"Worker", logo:"WORKER.png", status:"Ativo", lote:"3o", prod:"sim", rk:1, resp:"Bruno", producao:0, prontos:0, produzir:7282, restantes:7282 },
  { fornecedor:"Britânia", logo:"britania.png", status:"Ativo", lote:"6o", prod:"sim", rk:2, resp:"Lucas", producao:96, prontos:0, produzir:96, restantes:0 },
  { fornecedor:"MTX", logo:"MTX.png", status:"Ativo", lote:"5o", prod:"sim", rk:1, resp:"Lucas", producao:848, prontos:0, produzir:848, restantes:0 },
  ...
  { fornecedor:"Bosch", logo:"Bosch.png", status:"Ativo", lote:"2o", prod:"próximo", rk:1, resp:"Bruno", producao:1200, prontos:0, produzir:1200, restantes:0 },
  ...
  { fornecedor:"Tramontina 2", logo:"Tramontina.png", status:"Ativo", lote:"4o", prod:"espera", rk:1, resp:"Lucas", producao:0, prontos:2346, produzir:6500, restantes:4154 },
  ...
  { fornecedor:"FOXLUX", logo:"FOXLUX.png", status:"Novo", lote:"1o", prod:"espera", rk:2, resp:"s/ resp.", producao:0, prontos:0, produzir:1600, restantes:1600 },
  ...
  { fornecedor:"Beta", logo:"Beta.png", status:"Ativo", lote:"2o", prod:"indefinido", rk:3, resp:"s/ resp.", producao:0, prontos:0, produzir:0, restantes:0 },
  ...
  { fornecedor:"Branco", logo:"Branco.png", status:"Ativo", lote:"2o", prod:"indefinido", rk:4, resp:"Jone", producao:0, prontos:0, produzir:250, restantes:250 },
